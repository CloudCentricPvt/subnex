...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var onboardingDone = localStorage.read("Is_Onboarding_Done");
    var loginDone = localStorage.read("Is_Login_Done");
    ...
    return GetMaterialApp(
      ...
      home: onboardingDone == true && loginDone == true
          ? const HomeScreen()
          : onboardingDone == true && loginDone == null
              ? const LoginInScreen()
